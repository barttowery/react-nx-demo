...
/* Note - Disabling because there are dummy anchors in this demo which throw a11y errors */
import { FooterData } from '@react-nx-demo/sales-models';
import { Separator } from "@react-nx-demo/shared-ui";
      ...
      <div className="max-w-7xl xl:px-16 lg:px-8 px-4 mx-auto">
        <div className="flex flex-col gap-6 sm:gap-12">
          <div className="py-12 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 lg:grid-cols-12 gap-x-8 gap-y-10 px-6 xl:px-0">
            <div className="col-span-full lg:col-span-4">
              <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-100 ease-in-out fill-mode-both">
                {/* Logo */}
                <a href="#">
                  <div className='flex justify-start gap-2 max-lg:gap-4 max-[550px]:[&_span]:hidden'>
                    <SquareCodeIcon className='size-8.5 text-primary' />
                    <span className='text-xl font-bold text-foreground'>Bart's Byte Builders</span>
                  </div>
                </a>
          ...
          <p className="text-sm font-normal text-muted-foreground text-center animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-100 ease-in-out fill-mode-both">
            ©2026 Bart's Byte Builders. All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
